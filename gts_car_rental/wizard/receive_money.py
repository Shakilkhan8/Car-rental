...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _compute_journal_id(self):
        for wizard in self:
            print('wizard.company_id.id',wizard.company_id.id)
            domain = [
                ('type', 'in', ('bank', 'cash')),
    ...
    def _compute_amount(self):
        ...
        for wizard in self:
            print("---------------------->",wizard)
            if sale_id.advance_payment or sale_id.security_deposit and not sale_id.total_amount_paid:
                wizard.amount = sale_id.advance_payment + sale_id.security_deposit
    ...
    def action_create_payments(self):
        ...
        payment.action_post()
        # print('dfggfdsasfg',sale_id,sale_id.compute_paid_amount())
        sale_id.compute_paid_amount()
